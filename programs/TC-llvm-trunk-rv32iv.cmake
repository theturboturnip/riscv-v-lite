...
set( CMAKE_SYSTEM_PROCESSOR     rv32iv   )
...
message(FATAL_ERROR "RISC-V CLANG not found. ${RISCV_CLANG_COMPILER_MAYBE}")
endif()

message( "RISC-V CLANG found: ${RISCV_CLANG_COMPILER}")
...
message( "RISC-V LLVM Path: ${RISCV_TOOLCHAIN_BIN_PATH}" )
...
set( CMAKE_EXE_LINKER_FLAGS   "${CMAKE_EXE_LINKER_FLAGS}  --target=riscv32" )
