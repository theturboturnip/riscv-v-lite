...
set( CMAKE_SYSTEM_PROCESSOR     rv32imv0p10   )
...
message(FATAL_ERROR "RISC-V CLANG-13 not found. ${RISCV_CLANG_COMPILER_MAYBE}")
endif()
...
set(RISCV_TOOLCHAIN_BIN_SUFFIX "-13")

message( "RISC-V LLVM-13 Path: ${RISCV_TOOLCHAIN_BIN_PATH}" )
