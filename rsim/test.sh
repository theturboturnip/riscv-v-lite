...
cargo run direct rv64imvxcheri ../programs/build/llvm-13-rv64imvxcheri/vector_memcpy/vector_memcpy.elf
cargo run direct rv64imvxcheri ../programs/build/llvm-13-rv64imvxcheri/hello_world/hello_world.elf
cargo run direct rv64imvxcheri ../programs/build/llvm-13-rv64imvxcheri/vector_memcpy_pointers/vector_memcpy_pointers.elf

cargo run direct rv64imvxcheri-int ../programs/build/llvm-13-rv64imvxcheri-int/vector_memcpy/vector_memcpy.elf
cargo run direct rv64imvxcheri-int ../programs/build/llvm-13-rv64imvxcheri-int/hello_world/hello_world.elf
cargo run direct rv64imvxcheri-int ../programs/build/llvm-13-rv64imvxcheri-int/vector_memcpy_pointers/vector_memcpy_pointers.elf
